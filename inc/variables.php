<?php 
    ...
    $description = 'Band, portrait, interiors, food, wedding photography in London and around the world.';
    ...
    portfolio/02_Another_Album/01_Image_Name.jpg
    Set this to false if you don't have leading digits for ordering.
    */
    $removeLeadingDigitsFromImgName = true;
    /********************************************************/
